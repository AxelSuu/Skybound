...
class Gameover:
    ...
    def show_go_screen(self):
        while self.on_gameover:
            ...
            draw_text(self.screen, f"Press V to play Level {GetScore()}", 22, self.WIDTH / 2, self.HEIGHT * 2 / 4)
            draw_text(self.screen, "Press Q to go to Main Menu", 22, self.WIDTH / 2, self.HEIGHT * 3 / 4)
            draw_text(self.screen, f"Highscore: {GetHighScore()}", 22, self.WIDTH / 2, self.HEIGHT * 1 / 4)
