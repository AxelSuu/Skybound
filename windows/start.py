...
class Start:
    ...
    def start_screen(self):
        ...
        while self.OnstartScreen:
            ...
            draw_text(self.screen, "Escape the monster", 50, self.WIDTH / 2, self.HEIGHT / 4)
            draw_text(self.screen, "Arrow keys to move, Space to jump", 22, self.WIDTH / 2, self.HEIGHT / 2)
            draw_text(self.screen, "Press V to play", 22, self.WIDTH / 2, self.HEIGHT * 3 / 4)
