...
class NewHighscore:
    ...
    def show_NH_screen(self):
        while self.on_NH:
            ...
            draw_text(self.screen, f"New Highscore!!", 50, self.WIDTH / 2, self.HEIGHT * 1 / 4)
            draw_text(self.screen, f"Highscore: {GetHighScore()}", 30, self.WIDTH / 2, self.HEIGHT * 1 / 4 + 70)
