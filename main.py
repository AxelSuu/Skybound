...
class Main_Loop:
    ...
    def __init__(self):
        ...
        self.sfx_folder_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "sfxs"))
        pg.init()
        pg.mixer.init()
        ...
        SetGamestate("MAIN_MENU") # Example of setting game state using database_logic.py
